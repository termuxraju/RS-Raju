...
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m𝙈𝙧 R-A-J-U

\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m01775456709

\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1mMR RAJU
...
def crack2(idf,pwv):
	...
	print('\r%s [X RAJU] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				if 'ya' in oprek:
					...
					print('\r%s [X RAJU-CP] %s|%s        '%(b,idf,pw))
